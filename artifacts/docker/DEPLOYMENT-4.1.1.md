# MoonTV 4.1.1 Docker 直接部署说明

本说明适用于不使用 Docker Compose、直接运行 Docker 容器，并由宿主机 Nginx 提供 HTTPS 反向代理的环境。交付镜像为 Linux AMD64 Docker 归档，导入后的本地标签为 `moontv:4.1.1`，应用内版本显示为 `4.1.1`。
...
从 [v4.1.1 Release](https://github.com/middleeastbreak/MoonTV/releases/tag/v4.1.1) 下载以下两个文件，并放在同一目录：
...
docker image inspect moontv:4.1.1 \
